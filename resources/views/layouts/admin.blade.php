            ...
            <div class="flex items-center justify-between h-16 px-4 lg:px-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <nav class="hidden md:flex items-center gap-1.5 text-sm">
                        <a href="{{ route('admin.dashboard') ?? '#' }}" class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">Dashboard</a>
                        @hasSection('breadcrumb')
                            ...
                            <span class="text-gray-700 dark:text-gray-300 font-medium">@yield('breadcrumb')</span>
                        @endif
                    </nav>
                </div>
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <div class="px-4 py-3 border-b border-gray-100 dark:border-white/5">
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ Auth::user()->name ?? 'Admin' }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ Auth::user()->email ?? 'admin@sportz.id' }}</p>
                            </div>
                            <div class="py-1">
