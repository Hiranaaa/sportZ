...
<aside class="fixed inset-y-0 left-0 z-50 flex flex-col bg-white dark:bg-navy-950 border-r border-gray-100 dark:border-white/5 transition-all duration-300"
    ...
    <div class="flex items-center h-16 px-4 border-b border-gray-100 dark:border-white/5 flex-shrink-0">
        <a href="<?php echo e(url('/admin/dashboard')); ?>" class="flex items-center gap-2.5 overflow-hidden">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 no-scrollbar">
        ...
        <a href="<?php echo e(url('/admin/dashboard')); ?>"
           class="<?php echo e(request()->is('admin/dashboard*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Dashboard">
        ...
        <a href="<?php echo e(url('/admin/courts')); ?>"
           class="<?php echo e(request()->is('admin/courts*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Lapangan">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/bookings')); ?>"
           class="<?php echo e(request()->is('admin/bookings*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Booking">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/payments')); ?>"
           class="<?php echo e(request()->is('admin/payments*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Pembayaran">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/promotions')); ?>"
           class="<?php echo e(request()->is('admin/promotions*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Promosi">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/vouchers')); ?>"
           class="<?php echo e(request()->is('admin/vouchers*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Voucher">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/banners')); ?>"
           class="<?php echo e(request()->is('admin/banners*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Banner">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/reviews')); ?>"
           class="<?php echo e(request()->is('admin/reviews*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Ulasan">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/testimonials')); ?>"
           class="<?php echo e(request()->is('admin/testimonials*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Testimoni">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/faqs')); ?>"
           class="<?php echo e(request()->is('admin/faqs*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="FAQ">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/users')); ?>"
           class="<?php echo e(request()->is('admin/users*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Pengguna">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/reports')); ?>"
           class="<?php echo e(request()->is('admin/reports*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Laporan">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/activity-logs')); ?>"
           class="<?php echo e(request()->is('admin/activity-logs*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Log Aktivitas">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?php echo e(url('/admin/settings')); ?>"
           class="<?php echo e(request()->is('admin/settings*') ? 'sidebar-link-active' : 'sidebar-link'); ?>"
           title="Pengaturan">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <div class="p-3 border-t border-gray-100 dark:border-white/5 flex-shrink-0">
        <a href="<?php echo e(url('/')); ?>" class="sidebar-link" title="Kembali ke Website">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<?php /**PATH C:\laragon\www\sportZ\resources\views/layouts/partials/sidebar-admin.blade.php ENDPATH**/ ?>